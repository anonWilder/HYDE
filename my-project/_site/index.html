        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center">
                <h1
                    ...
                    <span class="block text-4xl md:text-5xl mb-4 sm:mb-0">Welcome to my portfolio</span><span
                        class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br logo-gradient md:inline-block drop-shadow-2xl tracking-normal">TechKen</span>
                </h1>
                <div class="mx-auto mt-8 sm:mt-4 text-gray-200 md:mt-8 md:max-w-2xl md:text-center">
                    <section aria-label="About Hyde">
                        <p class="lg:text-lg">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti, nemo? Labore facilis rerum quos? Ratione, nam eveniet doloremque adipisci placeat aspernatur in ducimus quis ipsa eius facere. Animi quas explicabo hic officia quibusdam ipsam porro corrupti suscipit minus cumque voluptatum nemo, dolores, fuga culpa, autem aut iste veniam! Voluptate, consequatur!
                        </p>
                    </section>
